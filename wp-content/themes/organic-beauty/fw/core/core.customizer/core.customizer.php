...
if ( !function_exists( 'organic_beauty_core_customizer_admin_menu_item' ) ) {
	//Handler of add_action('admin_menu', 'organic_beauty_core_customizer_admin_menu_item');
...
if ( !function_exists( 'organic_beauty_core_customizer_load_options' ) ) {
	//Handler of add_action( 'organic_beauty_action_load_main_options', 'organic_beauty_core_customizer_load_options' );
	function organic_beauty_core_customizer_load_options() {
		$mode = isset($_POST['mode']) ? organic_beauty_get_value_gp('mode') : '';
		$override = isset($_POST['override']) ? organic_beauty_get_value_gp('override') : '';
...
if ( !function_exists( 'organic_beauty_core_customizer_save_options' ) ) {
	//Handler of add_action('wp_ajax_organic_beauty_options_save', 'organic_beauty_core_customizer_save_options');
	//Handler of add_action('wp_ajax_nopriv_organic_beauty_options_save', 'organic_beauty_core_customizer_save_options');
	function organic_beauty_core_customizer_save_options() {

		$mode = organic_beauty_get_value_gp('mode');
		$override = empty($_POST['override']) ? '' : organic_beauty_get_value_gp('override');
		...
		parse_str(organic_beauty_get_value_gp('data'), $data);
...
if ( !function_exists( 'organic_beauty_core_customizer_scheme_delete' ) ) {
	//Handler of add_action('wp_ajax_organic_beauty_options_scheme_delete', 'organic_beauty_core_customizer_scheme_delete');
	//Handler of add_action('wp_ajax_nopriv_organic_beauty_options_scheme_delete', 'organic_beauty_core_customizer_scheme_delete');
	function organic_beauty_core_customizer_scheme_delete() {

		if ( !wp_verify_nonce( organic_beauty_get_value_gp('nonce'), admin_url('admin-ajax.php') ) || !current_user_can('manage_options'))
			wp_die();

		$scheme = organic_beauty_get_value_gp('scheme');
		$colors = organic_beauty_storage_get('custom_colors');
		$order = !empty($_POST['order']) ? explode(',', organic_beauty_get_value_gp('order')) : array_keys($colors);
...
if ( !function_exists( 'organic_beauty_core_customizer_scheme_copy' ) ) {
	//Handler of add_action('wp_ajax_organic_beauty_options_scheme_copy', 'organic_beauty_core_customizer_scheme_copy');
	//Handler of add_action('wp_ajax_nopriv_organic_beauty_options_scheme_copy', 'organic_beauty_core_customizer_scheme_copy');
...
if (!function_exists('organic_beauty_core_customizer_compile_less')) {
	//Handler of add_action('organic_beauty_action_compile_less', 'organic_beauty_core_customizer_compile_less');
...
if (!function_exists('organic_beauty_core_customizer_prepare_less')) {
	//Handler of add_filter('organic_beauty_filter_prepare_less', 'organic_beauty_core_customizer_prepare_less');
...
if (!function_exists('organic_beauty_core_customizer_load_scripts')) {
	function organic_beauty_core_customizer_load_scripts() {
		if (file_exists(organic_beauty_get_file_dir('core/core.customizer/core.customizer.css')))
			wp_enqueue_style( 'organic-beauty-core-customizer-style',	organic_beauty_get_file_url('core/core.customizer/core.customizer.css'), array(), null);
		if (file_exists(organic_beauty_get_file_dir('core/core.customizer/core.customizer.js')))
			wp_enqueue_script( 'organic-beauty-core-customizer-script', organic_beauty_get_file_url('core/core.customizer/core.customizer.js'), array(), null );
	}
}
