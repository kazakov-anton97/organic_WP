...
if ( !function_exists( 'organic_beauty_options_custom_load_scripts' ) ) {
	//Handler of add_action("admin_enqueue_scripts", 'organic_beauty_options_custom_load_scripts');
	function organic_beauty_options_custom_load_scripts() {
		wp_enqueue_script( 'organic-beauty-options-custom-script',	organic_beauty_get_file_url('core/core.options/js/core.options-custom.js'), array(), null, true );
	}
}
