...
if (!function_exists('organic_beauty_customizer_wp_register_controls')) {
	//Handler of add_action( 'customize_register', 'organic_beauty_customizer_wp_register_controls', 11 );
...
if (!function_exists('organic_beauty_customizer_wp_custom_controls')) {
	//Handler of add_action( 'customize_register', 'organic_beauty_customizer_wp_custom_controls' );
...
if (!function_exists('organic_beauty_customizer_wp_load_mods')) {
	//Handler of add_action( 'wp_loaded', 'organic_beauty_customizer_wp_load_mods' );
...
if (!function_exists('organic_beauty_customizer_wp_action_save_after')) {
	//Handler of add_action('customize_save_after', 'organic_beauty_customizer_wp_action_save_after');
...
if ( !function_exists( 'organic_beauty_customizer_wp_control_js' ) ) {
	//Handler of add_action( 'customize_controls_enqueue_scripts', 'organic_beauty_customizer_wp_control_js' );
	function organic_beauty_customizer_wp_control_js() {
		wp_enqueue_style( 'organic-beauty-customizer-wp', organic_beauty_get_file_url('core/core.customizer.wp/core.customizer.wp.css') );
		wp_enqueue_script( 'organic-beauty-core-utils-script', organic_beauty_get_file_url('js/core.utils.js'), array(), null, true );
		wp_enqueue_script( 'organic-beauty-customizer-wp-color-scheme-control', organic_beauty_get_file_url('core/core.customizer.wp/core.customizer.wp.color-scheme.js'), array( 'customize-controls', 'iris', 'underscore', 'wp-util' ) );
		wp_localize_script( 'organic-beauty-customizer-wp-color-scheme-control', 'organic_beauty_color_schemes', organic_beauty_storage_get('custom_colors') );
		wp_localize_script( 'organic-beauty-customizer-wp-color-scheme-control', 'organic_beauty_fonts', organic_beauty_storage_get('custom_fonts') );
		wp_localize_script( 'organic-beauty-customizer-wp-color-scheme-control', 'organic_beauty_dependencies', organic_beauty_storage_get('customizer_depends') );
		wp_localize_script( 'organic-beauty-customizer-wp-color-scheme-control', 'organic_beauty_customizer_vars', array(
...
if ( !function_exists( 'organic_beauty_customizer_wp_preview_js' ) ) {
	//Handler of add_action( 'customize_preview_init', 'organic_beauty_customizer_wp_preview_js' );
	function organic_beauty_customizer_wp_preview_js() {
		wp_enqueue_script( 'organic-beauty-customizer-wp-preview', organic_beauty_get_file_url('core/core.customizer.wp/core.customizer.wp.preview.js'), array( 'customize-preview' ) );
		wp_localize_script( 'organic-beauty-customizer-wp-preview', 'organic_beauty_previewer_vars', array(
			'need_refresh' => organic_beauty_get_theme_setting('less_compiler')!='no',
