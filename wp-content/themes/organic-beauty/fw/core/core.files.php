...
if (!function_exists('organic_beauty_get_socials_dir')) {	
	function organic_beauty_get_socials_dir($soc, $return_url=false) {
		return organic_beauty_get_file_dir('images/socials/' . sanitize_file_name($soc) . (organic_beauty_strpos($soc, '.')===false ? '.png' : ''), $return_url, true);
	}
}
...
if (!function_exists('organic_beauty_get_template_dir')) {	
	function organic_beauty_get_template_dir($tpl) {
		return organic_beauty_get_file_dir('templates/' . sanitize_file_name($tpl) . (organic_beauty_strpos($tpl, '.php')===false ? '.php' : ''));
	}
}
