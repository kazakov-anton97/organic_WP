...
organic_beauty_storage_set('options_prefix', 'organic_beauty');	// Prefix for the theme options in the postmeta and wp options
...
require_once ORGANIC_BEAUTY_THEME_PATH . 'plugins/plugin.contact-form-7.php';
require_once ORGANIC_BEAUTY_THEME_PATH . 'plugins/plugin.elegro-payment.php';
require_once ORGANIC_BEAUTY_THEME_PATH . 'plugins/plugin.essgrids.php';
require_once ORGANIC_BEAUTY_THEME_PATH . 'plugins/plugin.gutenberg.php';
require_once ORGANIC_BEAUTY_THEME_PATH . 'plugins/plugin.gdpr-compliance.php';
...
require_once ORGANIC_BEAUTY_THEME_PATH . 'plugins/plugin.trx_updater.php';
