...
<div class="top_panel_top_user_area">
	...
	if (in_array('socials', $top_panel_top_components) && organic_beauty_get_custom_option('show_socials')=='yes') {
		...
		<div class="top_panel_top_socials">
			<?php if(function_exists('organic_beauty_sc_socials')) organic_beauty_show_layout(organic_beauty_sc_socials(array('size'=>'tiny'))); ?>
		</div>
		<?php
	}
		...
		if ( !is_user_logged_in() ) {
			...
			<li class="menu_user_controls">
				...
				<ul>
					...
					<?php } ?>
					<li><a href="<?php echo esc_url(get_edit_user_link()); ?>" class="icon icon-cog"><?php esc_html_e('Settings', 'organic-beauty'); ?></a></li>
				</ul>
			</li>
