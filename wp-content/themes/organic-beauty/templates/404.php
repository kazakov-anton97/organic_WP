	...
	function organic_beauty_template_404_output() {
		...
		<article class="post_item post_item_404">
			<div class="post_content">
				...
				<div class="page_search"><?php if(function_exists('organic_beauty_sc_search')) organic_beauty_show_layout(organic_beauty_sc_search(array('state'=>'fixed', 'title'=>__('To search type and hit enter', 'organic-beauty')))); ?></div>
			</div>
		</article>
		<?php
	}
