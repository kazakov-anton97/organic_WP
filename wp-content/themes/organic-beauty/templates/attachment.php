...
if ( !function_exists( 'organic_beauty_template_attachment_output' ) ) {
	function organic_beauty_template_attachment_output($post_options, $post_data) {
		...
		<article <?php post_class('post_item post_item_attachment template_attachment'); ?>>
			...
			<<?php echo esc_attr($title_tag); ?> class="post_title"><?php echo !empty($post_data['post_excerpt']) ? strip_tags($post_data['post_excerpt']) : $post_data['post_title']; ?></<?php echo esc_attr($title_tag); ?>>
