...
if (($show_counters && $show_counters != 'hide') && !organic_beauty_param_is_off($show_counters)) {
	...
	} else if (function_exists('organic_beauty_reviews_theme_setup') && organic_beauty_strpos($show_counters, 'stars')!==false || organic_beauty_strpos($show_counters, 'rating')!==false) {
