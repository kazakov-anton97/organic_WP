...
// Views
if ($show_all_counters || organic_beauty_strpos($post_options['counters'], 'views')!==false && function_exists('trx_utils_get_post_views')) {
	?>
...
// Likes
if ($show_all_counters || organic_beauty_strpos($post_options['counters'], 'likes')!==false && function_exists('trx_utils_get_post_likes')) {
	// Load core messages
	organic_beauty_enqueue_messages();
	$likes = isset($_COOKIE['organic_beauty_likes']) ? organic_beauty_get_value_gpc('organic_beauty_likes') : '';
