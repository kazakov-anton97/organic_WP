...
if ($post_data['post_edit_enable']) {
	...
	wp_enqueue_style ( 'fontello-admin',        organic_beauty_get_file_url('css/fontello-admin/css/fontello-admin.css'), array(), null);
	wp_enqueue_style ( 'organic-beauty-frontend-editor-style', organic_beauty_get_file_url('js/core.editor/core.editor.css'), array(), null );
	wp_enqueue_script( 'organic-beauty-frontend-editor',       organic_beauty_get_file_url('js/core.editor/core.editor.js'),  array(), null, true );
