...
if ( !function_exists( 'organic_beauty_instagram_widget_required_plugins' ) ) {
	//Handler of add_filter('organic_beauty_filter_required_plugins',	'organic_beauty_instagram_widget_required_plugins');
...
if ( !function_exists( 'organic_beauty_instagram_widget_frontend_scripts' ) ) {
	//Handler of add_action( 'organic_beauty_action_add_styles', 'organic_beauty_instagram_widget_frontend_scripts' );
	function organic_beauty_instagram_widget_frontend_scripts() {
		if (file_exists(organic_beauty_get_file_dir('css/plugin.instagram-widget.css')))
			wp_enqueue_style( 'organic-beauty-plugin-instagram-widget-style',  organic_beauty_get_file_url('css/plugin.instagram-widget.css'), array(), null );
	}
}
?>