...
if (!function_exists('organic_beauty_filter_theme_styles_used_fonts')) {
	//Handler of add_filter('organic_beauty_filter_used_fonts', 'organic_beauty_filter_theme_styles_used_fonts');
...
if (!function_exists('organic_beauty_filter_theme_styles_list_fonts')) {
	//Handler of add_filter('organic_beauty_filter_list_fonts', 'organic_beauty_filter_theme_styles_list_fonts');
...
if (!function_exists('organic_beauty_filter_theme_styles_compile_less')) {
	//Handler of add_filter('organic_beauty_filter_compile_less', 'organic_beauty_filter_theme_styles_compile_less');
...
if (!function_exists('organic_beauty_action_theme_styles_add_styles')) {
	//Handler of add_action('organic_beauty_action_add_styles', 'organic_beauty_action_theme_styles_add_styles');
	function organic_beauty_action_theme_styles_add_styles() {
		...
		if ( organic_beauty_get_theme_setting('less_compiler') != 'no' ) {
			wp_enqueue_style( 'organic-beauty-theme-style', organic_beauty_get_file_url('css/theme.css'), array(), null );
			wp_add_inline_style( 'organic-beauty-theme-style', organic_beauty_get_inline_css() );
		}
	}
}
...
if (!function_exists('organic_beauty_filter_theme_styles_add_styles_inline')) {
	//Handler of add_filter('organic_beauty_filter_add_styles_inline', 'organic_beauty_filter_theme_styles_add_styles_inline');
...
if (!function_exists('organic_beauty_action_theme_styles_add_scripts')) {
	//Handler of add_action('organic_beauty_action_add_scripts', 'organic_beauty_action_theme_styles_add_scripts');
...
if (!function_exists('organic_beauty_filter_theme_styles_localize_script')) {
	//Handler of add_filter('organic_beauty_filter_localize_script',		'organic_beauty_filter_theme_styles_localize_script');
