...
if ( !function_exists( 'organic_beauty_options_settings_theme_setup' ) ) {
	...
	function organic_beauty_options_settings_theme_setup() {
		...
		// Theme options array
		organic_beauty_storage_set('options', apply_filters('organic_beauty_filter_options', array(
		...
		"footer_copyright" => array(
					...
					"allow_html" => true,
					"std" => "Organic Beauty &copy; {Y} All Rights Reserved ",
					"rows" => "10",
					"type" => "editor"),
		...
		'page_preloader_image' => array(
            ...
            'privacy_text' => array(
                "title" => esc_html__("Text with Privacy Policy link", 'organic-beauty'),
                "desc"  => wp_kses_data( __("Specify text with Privacy Policy link for the checkbox 'I agree ...'", 'organic-beauty') ),
                "std"   => wp_kses_post( __( 'I agree that my submitted data is being collected and stored.', 'organic-beauty') ),
                "type"  => "text"
            ),
		...
		"info_contact_3" => array(
					...
					"desc" => wp_kses_data( __('What function use to send mail: the built-in Wordpress or standard PHP function? Attention! Some plugins may not work with one of them and you always have the ability to switch to alternative.', 'organic-beauty') ),
					"type" => "info"),
...
if ( !function_exists( 'organic_beauty_options_reset' ) ) {
	//Handler of add_action('after_switch_theme', 'organic_beauty_options_reset');
