 ...
 */
			...
			if (organic_beauty_get_custom_option('show_twitter_in_footer')=='yes' &&  function_exists('organic_beauty_sc_twitter')) {
			...
			if ( organic_beauty_get_custom_option('show_googlemap')=='yes' ) { 
				...
				if (!empty($map_address) || !empty($map_latlng)) {
					...
					if (!empty($map_height))	$args['height'] = esc_attr($map_height);
                        ...
                        if(function_exists('organic_beauty_sc_googlemap')) organic_beauty_show_layout(organic_beauty_sc_googlemap($args));
				}
			}
				...
				<div class="copyright_wrap copyright_style_<?php echo esc_attr($copyright_style); ?> <?php echo esc_attr($footer_show_contacts_area); ?> scheme_<?php echo esc_attr(organic_beauty_get_custom_option('copyright_scheme')); ?>">
					<div class="copyright_wrap_inner">
						<div class="content_wrap">
							...
							?>
							<div class="copyright_text"><?php organic_beauty_show_layout(force_balance_tags(do_shortcode(str_replace(array('{{Y}}', '{Y}'), date('Y'), organic_beauty_get_custom_option('footer_copyright'))))); ?></div>
							<?php
							if ($copyright_style == 'socials' && function_exists('organic_beauty_sc_socials')) {
