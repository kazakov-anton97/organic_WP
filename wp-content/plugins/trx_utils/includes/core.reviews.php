...
if ( !function_exists( 'organic_beauty_reviews_check_criterias' ) ) {
	//Handler of add_action('wp_ajax_check_reviews_criterias', 'organic_beauty_reviews_check_criterias');
	//Handler of add_action('wp_ajax_nopriv_check_reviews_criterias', 'organic_beauty_reviews_check_criterias');
	function organic_beauty_reviews_check_criterias() {
		...
		$ids = explode(',', organic_beauty_get_value_gp('ids'));
...
if ( !function_exists( 'organic_beauty_reviews_accept_user_marks' ) ) {
	//Handler of add_action('wp_ajax_reviews_users_accept', 'organic_beauty_reviews_accept_user_marks');
	//Handler of add_action('wp_ajax_nopriv_reviews_users_accept', 'organic_beauty_reviews_accept_user_marks');
	function organic_beauty_reviews_accept_user_marks() {
		...
		if ($post_id > 0) {
			$marks = organic_beauty_get_value_gp('marks');
			$users = organic_beauty_get_value_gp('users');
