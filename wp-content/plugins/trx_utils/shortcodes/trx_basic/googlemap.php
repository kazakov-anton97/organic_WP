...
if (!function_exists('organic_beauty_sc_googlemap')) {
	function organic_beauty_sc_googlemap($atts, $content = null) {
        ...
        if ( organic_beauty_get_theme_option('api_google') != '') {
	...
	add_shortcode("trx_googlemap", "organic_beauty_sc_googlemap");
}
...
if (!function_exists('organic_beauty_sc_googlemap_marker')) {
	...
	add_shortcode("trx_googlemap_marker", "organic_beauty_sc_googlemap_marker");
}
