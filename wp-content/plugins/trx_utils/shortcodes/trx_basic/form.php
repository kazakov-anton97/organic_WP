...
if (!function_exists('organic_beauty_sc_form')) {	
	...
	add_shortcode("trx_form", "organic_beauty_sc_form");
}
...
if (!function_exists('organic_beauty_sc_form_item')) {	
	function organic_beauty_sc_form_item($atts, $content=null) {
		...
		if ($type == 'textarea')
			...
			wp_enqueue_script( 'jquery-picker', organic_beauty_get_file_url('/js/picker/picker.js'), array('jquery'), null, true );
			wp_enqueue_script( 'jquery-picker-date', organic_beauty_get_file_url('/js/picker/picker.date.js'), array('jquery'), null, true );
			...
			wp_enqueue_script( 'jquery-picker', organic_beauty_get_file_url('/js/picker/picker.js'), array('jquery'), null, true );
			wp_enqueue_script( 'jquery-picker-time', organic_beauty_get_file_url('/js/picker/picker.time.js'), array('jquery'), null, true );
	...
	add_shortcode('trx_form_item', 'organic_beauty_sc_form_item');
}
...
if ( !function_exists( 'organic_beauty_sc_form_send' ) ) {
	function organic_beauty_sc_form_send() {
		...
		if (!($contact_email = organic_beauty_get_theme_option('contact_email')) && !($contact_email = organic_beauty_get_theme_option('admin_email'))) 
			...
			$mail = organic_beauty_get_theme_option('mail_function') == 'mail' ? 'mail' : 'wp_mail';
			if (is_email($contact_email) && !@$mail($contact_email, $subj, apply_filters('organic_beauty_filter_form_send_message', $msg))) {
